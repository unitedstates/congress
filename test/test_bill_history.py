...
class BillHistory(unittest.TestCase):
  ...
  def test_introduced_bill(self):
    ...
    self.assertTrue('house_passage_result' not in history)
    self.assertTrue('house_passage_result_at' not in history)
    self.assertTrue('senate_cloture_result' not in history)
    self.assertTrue('senate_cloture_result_at' not in history)
    self.assertTrue('senate_passage_result' not in history)
    self.assertTrue('senate_passage_result_at' not in history)
    self.assertEqual(history['vetoed'], False)
    self.assertEqual(history['awaiting_signature'], False)

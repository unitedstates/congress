...
class CongressMemberParser():
    ...
    def grab_congress_info(self, metadata: BeautifulSoup) -> List[CongressMemberInfo]:
        ...
        for congress_member in congress_sections:
            ...
            member_info = CongressMemberInfo(name = name, name_parsed = name_parsed, last_name = last_name,
                bio_guide_id = bioGuideId, authority_id = authorityId, role = role, state = state,
                party = party, chamber = chamber, gpoId = gpoId)
